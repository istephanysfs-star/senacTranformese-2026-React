    ...
    return ( //*tudo aqui é html e do lado de fora da () é js*//
        <>
            <nav class="flex items-center py-3 px-4 shadow-lg fixed top-0 w-full bg-secondary">
                <Link class="mr-2 p-2 hover:bg-primary hover:text-white" to="#about">Sobre</Link>
                <Link class="mr-2 p-2 hover:bg-primary hover:text-white" to="#prices">Preços</Link>
                <Link class="mr-2 p-2 hover:bg-primary hover:text-white" to="#features">Benefícios</Link>
                < Link class="mr-5 py-2 px-4 bg-primary hover:shadow-inner rounded text-white ml-auto shadow" to="/auth" >Acessar</Link>
            </nav>
            <div class="max-w-lg mx-auto py-6">
                <h1 class="text-center">Sobre o Curso Popular</h1>
